-- ============================================================================
-- ConflictCore — Multi-User File Management System
-- Database Schema: schema.sql (Core Database Architecture)
-- Tables: USERS, FOLDERS, FILES, FILE_PERMISSIONS, OPERATIONS, PROCESSES, FILE_LOCKS
-- Database: MySQL 8.0+ / 9.x (InnoDB Engine)
-- ============================================================================
...
-- ----------------------------------------------------------------------------
-- Drop existing tables in reverse dependency order (safe re-creation)
-- ----------------------------------------------------------------------------
